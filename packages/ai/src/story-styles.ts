...
export const STYLE_PRESETS: Record<string, string> = {
  "stick-openai":
    "A simple flat CARTOON STICK FIGURE character set inside a REALISTIC, richly detailed environment — the deliberate contrast (a minimalist stick figure living in a real-looking, highly detailed world) IS the whole style. THE FIGURE stays a minimalist doodle: a plain WHITE round head with a simple expressive face (dot eyes, eyebrows and a curved mouth) — DEFAULT to a warm, friendly, content SMILE — but an EXPLICIT action or feeling in the prompt ALWAYS overrides this default: if the prompt says the figure is asleep, draw him lying down with eyes closed; if crying, draw tears; if reaching, sitting, kneeling, so draw it. Draw the STATED pose and expression, never a generic standing smile on top of it. Thin single-line stick arms and legs; a simple dress or plain clothes on the body is fine, but the HEAD stays a white circle with a face and the visible ARMS and LEGS stay thin stick lines — never realistic or muscled limbs, never a detailed human. Keep the figure flat, clean and doodle-like (xkcd-ish) EVEN THOUGH the world around it is realistic. THE WORLD / BACKGROUND, by contrast, is RENDERED REALISTICALLY and in DENSE DETAIL: a believable, real-looking environment with true depth, real materials and textures, natural lighting and soft shadow, and layered foreground/middle/distance — like a detailed painting or photograph of the actual place, packed with the specific props, structures, plants and surroundings the scene describes. Never a flat, bare or cartoonish backdrop — the realism and detail live ENTIRELY in the WORLD, the flat simplicity ENTIRELY in the FIGURE. COMPOSITION: frame it a little WIDE — the figure is fairly small, taking up only about the lower third to half of the frame, PLACED within the scene in WHATEVER POSE the moment calls for (standing, sitting, kneeling, crouching, walking, lying down — match the prompt, do NOT default to standing), so the detailed world fills most of the picture around and above it; do NOT zoom in so the figure dominates. PALETTE: bright, clean and COLOURFUL using the FULL range of colour (fresh greens, sky blues, clear reds, clean whites), lit naturally for the time of day. CRITICAL: NO yellow/amber/orange/sepia wash or tint over the whole picture — that muddy overlay looks AI-made and cheap; light each scene cleanly and naturally (cool bright morning, full neutral daylight, gentle evening) with true, varied colours. Never grey, muddy, drab, desaturated, bleak or gloomy, and never uniformly yellow-tinted. Crisp, detailed and appealing to look at.",
  "hero-painterly":
  ...
  "stick-fal":
    "REALISTIC, richly detailed BACKGROUND of the specific place, objects and structures described — a believable, real-looking environment with true depth, real materials and textures, and natural lighting, densely detailed and full (small props, surroundings, layered foreground/middle/distance), like a detailed painting or photograph of the actual place, never a flat or bare backdrop. (A flat cartoon stick figure is composited on top afterwards — the realism lives entirely in this background.) PALETTE: bright, clean and colourful using the FULL range of colour (greens, blues, reds, whites), lit naturally for the time of day — NO yellow/amber/sepia wash or tint over the whole picture (that muddy overlay looks AI-made); never grey, muddy, drab or gloomy, and never uniformly yellow-tinted. Leave a wide, clear, mostly-empty foreground with open ground for the character. NO people, no characters, no figures of any kind — the character is added separately.",
};
