...
export const STYLE_PRESETS: Record<string, string> = {
  "stick-openai":
    "Minimalist flat 2D cartoon. The character(s) are simple STICK FIGURES: a plain WHITE round head with a simple expressive face (dot eyes, eyebrows and a curved mouth) — DEFAULT to a warm, friendly, content SMILE (a happy, at-ease look) — but an EXPLICIT action or feeling in the prompt ALWAYS overrides this default: if the prompt says the figure is asleep, draw him lying down with eyes closed; if crying, draw tears; if reaching, sitting, kneeling, so draw it. Draw the STATED pose and expression, never a generic standing smile on top of it — and thin single-line stick arms and legs. A simple dress or plain clothes on the body is fine — do NOT force a bare body — but the HEAD stays a white circle with a face and the visible ARMS and LEGS stay thin stick lines, never realistic or muscled limbs. Keep every figure simple and doodle-like (xkcd-ish), never a detailed or realistic cartoon person. COMPOSITION: frame it a little WIDE — the figure is fairly small, taking up only about the lower third to half of the frame, PLACED within the scene in WHATEVER POSE the moment calls for (standing, sitting, kneeling, crouching, walking, lying down — match the prompt, do NOT default to standing), rather than filling it, so plenty of the world shows around and above them. The BACKGROUND fills most of the picture and should be RICHLY DETAILED — the FIGURE stays a plain simple doodle, but the world around it does not: pack the scene with the specific place plus its smaller props, textures, plants and furnishings, and a sense of depth (foreground, middle, distance), so it looks full and lived-in, never a bare backdrop. Do NOT zoom in so the character dominates. The SCENE around them is an accurate, clearly-readable, detailed COLOURFUL world showing the specific place, objects and structures described — bold clean outlines, flat bright colours, light shading, no photorealism; the 'keep it simple' rule applies to the STICK FIGURE only, not to the background. PALETTE: bright, clean and COLOURFUL — a cheerful storybook look using the FULL range of colour (fresh greens, sky blues, clear reds, clean whites), like a bright clear day. CRITICAL: NO yellow/amber/orange/sepia wash or tint over the whole picture — that muddy yellow overlay looks AI-made and cheap; every scene is lit cleanly and naturally for its time of day (cool bright morning, full neutral daylight, gentle evening), with true, varied colours. Stay saturated and inviting, NEVER grey, muddy, drab, desaturated, bleak or gloomy — but equally NEVER uniformly yellow-tinted. Crisp, clear and appealing to look at.",
  "hero-painterly":
