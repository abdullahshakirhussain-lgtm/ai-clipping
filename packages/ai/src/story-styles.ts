...
export const STYLE_PRESETS: Record<string, string> = {
  ...
  "stick-fpv":
    "FIRST-PERSON POV ('pov') with a signature TRADEMARK look: the camera IS the viewer's own eyes, and when you act your OWN hands and forearms enter frame drawn as a FLAT CARTOON STICK FIGURE — simple doodle hands with a plain outline (thin black lines, minimal or plain-white fill, xkcd-ish), NOT realistic hands. This deliberate contrast — flat cartoon stick-figure hands living inside a RICHLY DETAILED, believable world — IS the whole style and must be kept every shot. The protagonist's FACE is NEVER shown: no front-facing face, no mirror, no reflection, no selfie — the viewer is inside the body looking out. The WORLD / BACKGROUND is the true subject and FILLS the whole vertical frame: a densely detailed, real-feeling environment with depth, materials, textures, natural lighting and layered foreground/middle/distance — pack it with the specific props, structures and life the scene describes. Only the HANDS/arms stay flat and doodle-like; everything else is richly rendered. PALETTE: bright, clean and COLOURFUL across the full range, lit naturally for the time of day — NO yellow/amber/sepia wash or tint; never grey, muddy or drab. Crisp, detailed and immersive.",
  "stick-fal":
