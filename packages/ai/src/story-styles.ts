...
export const STYLE_PRESETS: Record<string, string> = {
  ...
  "pov-real":
    "Photorealistic cinematic FIRST-PERSON POV ('pov'): the camera IS the viewer's own eyes, natural eye-level, gentle handheld. When you act, your own REALISTIC hands and forearms enter frame from the lower edge — ordinary natural skin, plain clothing/sleeves as the scene specifies; your FACE is NEVER shown (no front-facing view, mirror, reflection or selfie) — you are inside the body looking out. The richly detailed, real-feeling ENVIRONMENT is the true subject and FILLS the whole vertical frame: real materials, textures, depth and natural light, packed with the specific props and atmosphere the scene describes. Cinematic look — shallow depth of field, soft natural lighting, fine film grain, tasteful natural colour, immersive and atmospheric. Vertical 9:16.",
  "stick-fpv":
